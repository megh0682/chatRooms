...
import {Button,ui,grid,row,column} from 'semantic-ui-react';
...
class ChatRoomDetails extends React.Component {
  ...
  <div class="ui row">
    ...
    <SaveButton text={this.state.code} lang={this.state.mode} title={this.props.availableRoom.title} class="ui left floated"/>
    
    <Button onClick={this.clearCode.bind(this)} className="col-lg-12 ui right floated">clear code</Button>
  </div>
</div>
